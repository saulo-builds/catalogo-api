...
def _initialize_database():
    ...
    if _engine is None:
        ...
        if APP_ENV == "development":
            print("MODO DE DESENVOLVIMENTO: A usar a base de dados local MariaDB/MySQL.")
            ...
            print("AVISO: Nenhuma URL de produção encontrada. A usar a base de dados local como fallback.")
            DATABASE_URL = "mysql+mysqlconnector://root:@localhost/catalogo_inteligente"

        _engine = create_engine(DATABASE_URL)
        _SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=_engine)
        print("Engine do SQLAlchemy e SessionLocal inicializados com sucesso.")
